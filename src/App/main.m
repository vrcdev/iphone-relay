...
- (void)refresh {
    ...
    if (fd >= 0) {
        close(fd);
        _statusLabel.text = @"LISTENING on :9876";
        _statusLabel.textColor = UIColor.systemGreenColor;
    } else {
        _statusLabel.text = @"daemon not running";
